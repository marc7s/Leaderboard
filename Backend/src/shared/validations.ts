...
function isValidUsername(username: string) {
  return username === username.replace(/[^a-zA-Zåäö]/g, '');
}
function isValidTime(time: any) {
  return time === time.toString();
}
function isValidShortName(shortName: any) {
  return shortName === shortName.toString();
}
...
function isValidAlpha2Code(string: any) {
  return isValidString(string) && string.length === 2;
}

function missing(arr: any): boolean {
  return Array.isArray(arr)
    ? arr.some((val) => val === MISSING)
    : arr === MISSING;
}
...
export async function loginParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
  ...
  if (missing(username) || missing(password))
    return next(
      new ApiRequestMalformedError("'username' or 'password' parameter missing")
    );
  if (!isValidUsername(username))
    return next(
      new ApiRequestMalformedError("'username' parameter is invalid")
    );
...
export async function userIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function usernameParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function shortNameParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function timeParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function addTimeParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
  ...
  if (missing(configID)) {
    ...
    const checkGameID = checkParameter(
      gameID,
      'gameID',
      Number.isInteger,
      'is not an integer'
    ...
    const checkTrackID = checkParameter(
      trackID,
      'trackID',
      Number.isInteger,
      'is not an integer'
    ...
    const checkCarID = checkParameter(
      carID,
      'carID',
      Number.isInteger,
      'is not an integer'
    ...
    const checkWeatherID = checkParameter(
      weatherID,
      'weatherID',
      Number.isInteger,
      'is not an integer'
    ...
    const checkTyreID = checkParameter(
      tyreID,
      'tyreID',
      Number.isInteger,
      'is not an integer'
    ...
    const checkSetupID = checkParameter(
      setupID,
      'setupID',
      Number.isInteger,
      'is not an integer'
...
export async function timeIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function configIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function setupIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function validParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function carIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function shortAndFullNameParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
  ...
  const check1 = checkParameter(
    shortName,
    'shortName',
    isValidString,
    'is not a valid short name'
  );
  const check2 = checkParameter(
    fullName,
    'fullName',
    isValidString,
    'is not a valid full name'
  );
...
export async function nameParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function descriptionParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function alpha2CodeParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function gameIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function tyreIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function weatherIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function trackIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function countryIDParam(
  req: any,
  res: Response,
  next: NextFunction
): Promise<void> {
